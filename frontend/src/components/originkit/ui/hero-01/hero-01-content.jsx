...
const TRUSTED_LOGOS = [
  { src: asset("logo-2.svg"), alt: "Logoipsum", width: 95, height: 22 },
  { src: asset("logo-3.svg"), alt: "Logoipsum", width: 108, height: 21 },
  { src: asset("logo-4.svg"), alt: "Logoipsum", width: 78, height: 18 }
];
...
const MenuIcon = () => {
  return (
    <svg
      ...
      className="size-4.5"
    >
      <path d="M2.25 4.5h13.5M2.25 9h13.5M2.25 13.5h13.5" stroke="white" strokeWidth="1.75" strokeLinecap="round" />
    </svg>
  );
};
  ...
  return (
    ...
    >
      <span className="relative flex size-full items-center justify-center overflow-hidden rounded-full bg-linear-to-b from-[#e0e0e0] to-white shadow-[0_4px_10px_rgba(0,0,0,0.12),0_1px_2px_rgba(0,0,0,0.06),0_0_0_3px_rgba(255,255,255,0.65)]">
        <span aria-hidden="true" className="pointer-events-none absolute inset-0 rounded-full bg-white" />
        <img
          alt=""
          aria-hidden="true"
          src={asset("play.svg")}
...
const BrowserPreview = ({ active }) => {
  ...
  return (
    <motion.div
      ...
      transition={{ type: "tween", duration: prefersReducedMotion ? 0.2 : 0.45, ease: easeOutCubic }}
    >
      <div className="translate-y-6 rounded-[14px] bg-[#f4f0e8] p-[8.5px] shadow-[0_0_6px_1px_rgba(0,0,0,0.05),0_0_200px_rgba(0,0,0,0.08),0_15px_20px_-17px_rgba(0,0,0,0.13),0_7px_14px_-10px_rgba(0,0,0,0.08)] ipad:translate-y-14 ipad:rounded-[18px]">
        <div className="relative overflow-hidden rounded-[5.5px] ipad:rounded-[9.5px]">
          <img
            alt="Screening dashboard preview"
...
const SlideIn = ({ active, children, className, y = 20, duration = 0.3, onComplete }) => {
  const prefersReducedMotion = useReducedMotion();
  ...
  return (
    <motion.div
      ...
      initial={hidden}
      animate={active ? visible : hidden}
      transition={{ type: "tween", duration: prefersReducedMotion ? 0.2 : duration, ease: easeOutCubic }}
      onAnimationComplete={() => {
      ...
      >
        <div className="relative z-10 flex w-full flex-col items-center px-3 pt-3 ipad:px-4 ipad:pt-4">
          <motion.header
            ...
            transition={{ type: "tween", duration: prefersReducedMotion ? 0.2 : 0.3, ease: easeOutCubic }}
          ...
          >
            <a
              ...
              aria-label="RetinaVision AI home"
            >
              <img alt="" aria-hidden="true" src={asset("logo-mark.svg")} width={24} height={24} className="size-5 ipad:size-6" />
            ...
            <nav aria-label="Primary" className="flex items-center gap-3 ipad:gap-6">
              ...
              >
                ...
                />
                <span className="relative">Refer a Patient</span>
                <span
                  aria-hidden="true"
          ...
          >
            <div className="flex w-full flex-col items-center gap-3 ipad:gap-3.5">
              <SpotlightReveal
                ...
                text="Diabetic Retinopathy Screening Made Simple and Explainable"
                blur={6}
                delay={0}
                active={showHero}
              ...
              >
                <p className="px-1 text-[clamp(15px,2.5vw,16px)] font-medium leading-normal tracking-[-0.02em] text-pretty text-[#45545e] ipad:px-0">
                  We optimize for the single statistic that matters: the number of preventable
                  vision-loss cases caught early.
                </p>
              </SlideIn>
            </div>
